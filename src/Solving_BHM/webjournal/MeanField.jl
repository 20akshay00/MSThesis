...
# ╔═╡ d0dd2d20-59fc-11ed-375a-15c9101854c8
using Plots, Optim, LinearAlgebra, LaTeXStrings

# ╔═╡ 195e609a-35ce-431a-8fce-8743fc4096e3
begin
...
# ╔═╡ 631c3f45-8c7c-4a17-bafd-388f33ae5fc3
# ╠═╡ disabled = true
#=╠═╡
begin
	model = MeanField(10)
	...
	psi = get_order_parameter(model, t, U, mu, z)
	state = eigvecs(get_hamiltonian(model, t, U, mu, z, psi))[:, 1]

	plot(state, st = :scatter, label = "")
end
  ╠═╡ =#
