...
begin
	order_param = ED.var.(gs, [model.N[1]])
end;

# ╔═╡ 829a427f-e6f9-40d7-bd1e-04bc551f79bb
plot(t, mu, order_param, st = :heatmap)
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "bab0e43d5493e54846234d6993ab937f394f2842"
