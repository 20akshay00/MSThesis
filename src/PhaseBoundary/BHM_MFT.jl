...
# ╔═╡ 8358d0ea-6b72-44d0-b2a9-12dee11510ca
using Plots, Optim, LinearAlgebra, LaTeXStrings

# ╔═╡ b6194510-5f82-11ed-3350-5d33eb1c66f1
begin
	...
	function isMI(model; t, U, mu, z, psi_t = 1e-6)
...
# ╔═╡ 32e028fa-f39f-4707-9c2f-ed95d2b8d7e8
begin 
	npoints = 1000
	...
	for (i, m) in enumerate(mu)
		t[i] = binarySearch(model, 0.001, 0.05, 1e-5; U = 1., mu = m, z = 4, psi_t = 1e-6)
	end
end

# ╔═╡ 98013490-8a12-4392-aa49-1ea72b12848a
plot(t, mu, xlims = [0., 0.1])

# ╔═╡ 5b23c300-1557-46e3-8b1f-3cb5bd8cf0be
t
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "0144f025f9fdc4877fc7649c9bed3712bcf1c35a"
