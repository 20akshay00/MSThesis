...
# 	z, num_points = 4, 30
# 	t = range(start = 0.001, stop = 0.1, length = num_points)
...
#=╠═╡
save("./data/MFT_$(z)_$(V).jld", "t", t, "mu", mu, "order_param", order_param)
  ╠═╡ =#
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "1d807f0e3e7591d95a39f36abc7c2d1817b1d84b"
