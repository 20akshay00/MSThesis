...
# ╔═╡ 894f2942-3cbf-11ed-1d31-2135b0f8ba75
using Luxor, Plots

# ╔═╡ ec81b05f-78f6-4c9b-8764-d2824338d637
let
	theme(:dark)
	gr(dpi = 300)
	x = -2π:0.01:2π
	p1 = plot(x, (x) -> 2 * sin(2x)^2, label = "", ylims = (-1, 12), lw = 2, axis = nothing, framestyle = :box, size = (1000, 200))
	...
	savefig("superfluid.png")
	p1
end

# ╔═╡ b56cd93d-964c-4b65-9222-9fe80ec5610b
let
	theme(:dark)
	gr()
	x = -2π:0.01:2π
	p1 = plot(x, (x) -> 10 * sin(2x)^2, label = "", ylims = (-1, 12), lw = 2, axis = nothing, framestyle = :box, size = (950, 200))
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "7f0f957f647b585c53ea5ab0fe4aadecd59a1056"
